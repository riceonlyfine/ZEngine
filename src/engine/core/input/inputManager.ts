namespace ZE{
    ...
    export class InputManager{
        ...
        public static getMousePositoin() : Vector2{
        ...
        private static onMouseDown(event : MouseEvent) : void{
            ...
            Message.send("MOUSE_DOWN", this, new MouseContext(InputManager._leftDown, InputManager._rightDown, InputManager.getMousePositoin()));
        }
        ...
        private static onMouseUp(event : MouseEvent) : void{
            ...
            Message.send("MOUSE_UP", this, new MouseContext(InputManager._leftDown, InputManager._rightDown, InputManager.getMousePositoin()));
        }
